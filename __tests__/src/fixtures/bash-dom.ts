/**
 * DOM fixture for Bash aliases-reference page tests.
 * Mirrors the minimal structure needed for init functions to bind.
 */

export function buildBashDOM(): void {
  document.body.innerHTML = `
    ...
    <nav class="navbar navbar-expand-lg sticky-top" id="mainNav" aria-label="Main navigation">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">Bash Aliases</a>
      ...
      <div class="row">
        <aside class="col-lg-3 col-xl-2" id="tocSidebar">
          ...
          <nav class="nav flex-column nav-pills">
            ...
            <a class="nav-link" href="#prettyAliases">Pretty Aliases</a>
        ...
        <section class="col-lg-9 col-xl-10" id="aliasApp">
          <article id="systemSetup" class="mb-5">
            ...
            <div class="card alias-card mb-3" data-alias="show-home">
              <div class="card-body">
                <h5 class="alias-name">show-home</h5>
                <p>Display home path.</p>
              </div>
            </div>
          </article>
          ...
          <article id="prettyAliases" class="mb-5">
            <h2 class="h3 mb-4">Pretty Aliases</h2>
            <div class="card alias-card mb-3" data-alias="ll">
              <div class="card-body">
                <h5 class="alias-name">ll</h5>
                <p>Pretty ls.</p>
              </div>
            </div>
          </article>
          <article id="utilities" class="mb-5">
            <h2 class="h3 mb-4">Utilities</h2>
            <div class="card alias-card mb-3" data-alias="extract">
              <div class="card-body">
                <h5 class="alias-name">extract</h5>
                <p>Extract any archive.</p>
              </div>
            </div>
          </article>
        </section>
...
export function resetBashBindings(): void {
