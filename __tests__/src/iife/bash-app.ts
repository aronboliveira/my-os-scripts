/**
 * Bash Aliases Reference — Interactive Module
 * Extracted from Bash/Linux/aliases-references.html <script> element.
      ...
      (window as any).Vue.createApp({
        ...
        mounted() {
          (this as any).$nextTick(() => {
            const m = document.getElementById("aliasApp");
            if (m)
              for (const el of m.querySelectorAll("[data-bound]"))
